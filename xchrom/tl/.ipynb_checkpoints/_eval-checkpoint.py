...
def crosscell_aucprc(
    ...
    cell_input_key:str = 'zscore32_perpc',
    ...
    cell_input_key: str
        Key of the cell input embedding in the cell embedding adata.
    save_pred: bool
    ...
    cell_input_key = str(cell_input_key)
    ...
    atac_crosscell.obsm[cell_input_key] = rna_crosscell.obsm[cell_input_key]
...
def crosscell_nsls(
    ...
    celltype: str
        Key of the cell type in the cell embedding adata.
    save_pred: bool
    ...
    ad0.obsm[cell_input_key] = rna.obsm[cell_input_key]
...
def crosspeak_aucprc(
    ...
    ad_crosspeak.obsm[cell_input_key] = rna_crosspeak.obsm[cell_input_key]
...
def crossboth_aucprc(
    ...
    ad_crossboth.obsm[cell_input_key] = rna_crossboth.obsm[cell_input_key]
...
def denoise_nsls(
    ...
    ad.obsm[cell_input_key] = rna.obsm[cell_input_key]
